...
void FastMaxwellStefan::MatrixMultiply484_0
(
...
void FastMaxwellStefan::MatrixMultiply484_1
(
    double* __restrict__ matC,
    double* __restrict__ matA,  
    double* __restrict__ matB,
...
void FastMaxwellStefan::MatrixMultiply484_2
(
    double* __restrict__ matC,
    double* __restrict__ matA,  
    double* __restrict__ matB,
...
void FastMaxwellStefan::MatrixMultiply484_3
(
    double* __restrict__ matC,
    double* __restrict__ matA,  
    double* __restrict__ matB,
...
)
{
    ...
    for(int i = 0; i < N-3; i=i+4)
    {
        ...
        {// remain j
            ...
            matC[(i+0)*(N)+j+0] = this->get_elem0(Ci0j02v);
            matC[(i+0)*(N)+j+1] = this->get_elem1(Ci0j02v);
            matC[(i+0)*(N)+j+2] = this->get_elem2(Ci0j02v);

            matC[(i+1)*(N)+j+0] = this->get_elem0(Ci1j02v);
            matC[(i+1)*(N)+j+1] = this->get_elem1(Ci1j02v);
            matC[(i+1)*(N)+j+2] = this->get_elem2(Ci1j02v);

            matC[(i+2)*(N)+j+0] = this->get_elem0(Ci2j02v);
            matC[(i+2)*(N)+j+1] = this->get_elem1(Ci2j02v);
            matC[(i+2)*(N)+j+2] = this->get_elem2(Ci2j02v);

            matC[(i+3)*(N)+j+0] = this->get_elem0(Ci3j02v);
            matC[(i+3)*(N)+j+1] = this->get_elem1(Ci3j02v);
            matC[(i+3)*(N)+j+2] = this->get_elem2(Ci3j02v);
...
void FastMaxwellStefan::MatrixMultiply484_4
(
    double* __restrict__ matC,
    double* __restrict__ matA,  
    double* __restrict__ matB,
...
void FastMaxwellStefan::MatrixMultiply484_5
(
    double* __restrict__ matC,
    double* __restrict__ matA,  
    double* __restrict__ matB,
...
void FastMaxwellStefan::MatrixMultiply484_6
(
    double* __restrict__ matC,
    double* __restrict__ matA,  
    double* __restrict__ matB,
...
void FastMaxwellStefan::MatrixMultiply484_7
(
    double* __restrict__ matC,
    double* __restrict__ matA,  
    double* __restrict__ matB,
...
)
{
    ...
    for(int i = 0; i < N-3; i=i+4)
    {
        ...
        }
        {
            ...
            matC[(i+0)*(N)+j+4] = this->get_elem0(Ci0j46v);
            matC[(i+0)*(N)+j+5] = this->get_elem1(Ci0j46v);
            matC[(i+0)*(N)+j+6] = this->get_elem2(Ci0j46v);

            matC[(i+1)*(N)+j+4] = this->get_elem0(Ci1j46v);
            matC[(i+1)*(N)+j+5] = this->get_elem1(Ci1j46v);
            matC[(i+1)*(N)+j+6] = this->get_elem2(Ci1j46v);

            matC[(i+2)*(N)+j+4] = this->get_elem0(Ci2j46v);
            matC[(i+2)*(N)+j+5] = this->get_elem1(Ci2j46v);
            matC[(i+2)*(N)+j+6] = this->get_elem2(Ci2j46v);

            matC[(i+3)*(N)+j+4] = this->get_elem0(Ci3j46v);
            matC[(i+3)*(N)+j+5] = this->get_elem1(Ci3j46v);
            matC[(i+3)*(N)+j+6] = this->get_elem2(Ci3j46v);
        }
    }
    {
        int i = N-3;
